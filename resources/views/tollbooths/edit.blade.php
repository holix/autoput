        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('tollbooths.update', $tollbooth->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name', $tollbooth->name) }}" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-md-offset-2">
                                ...
                                <a href="{{ route('tollbooths.show', $tollbooth->id) }}" class="btn btn-default">
